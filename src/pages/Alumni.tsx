...
import { Users, Globe, MessageCircle, ArrowRight, ShieldCheck } from "lucide-react";
...
export default function Alumni() {
  ...
  return (
    <div className="bg-brand-bg overflow-hidden">
      <SEO title="Alumni Network — Mtshabezi High School" description="Connect with the Mtshabezi alumni community. Stay involved, give back, and celebrate our shared heritage through the Bezha Global Network." />
